import {FAMILY_LIST,ANIMAL_LIST, DELETE_ANIMAL} from "../constants.js";
import {getAnimalList, getFamilies, removeAnimal} from "../actions.js";
...
class SpecificFamilyPanel extends HTMLElement {
    ...
    update(prop) {
        if (prop.type == DELETE_ANIMAL) {
            getAnimalList(this.activeFamily);
            return;
        }
